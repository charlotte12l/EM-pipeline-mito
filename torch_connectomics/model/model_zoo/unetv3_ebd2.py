...
class unetv3_ebd2(nn.Module):
    ...
    def __init__(self, in_channel=1, out_channel=1, filters=[8, 12, 16, 20, 24], act='sigmoid', aux=False):
        ...
        # decoding path
        self.layer1_D_0 = conv3d_bn_elu(in_planes=filters[0], out_planes=filters[0],
                          kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1))
        self.layer1_D_1 = residual_block_2d(filters[0], filters[0], projection=False)
        self.layer1_D_2 = conv3d_bn_non(in_planes=filters[0], out_planes=out_channel,
              kernel_size=(1, 5, 5), stride=1, padding=(0, 2, 2))
        ...
        self.b1 = nn.Conv3d(8, 36, kernel_size=3, padding=1)
        #self.b2 = nn.Conv3d(24, 36, kernel_size=3, padding=1)
        # initialization
        ortho_init(self)
    ...
    def forward(self, x):
        ...
        x_a = self.layer1_D_1(x)
        x_a = self.layer1_D_2(x_a)
